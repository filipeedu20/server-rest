...
$.extend( $.validator, {
	...
	messages: {
		...
		digits: "Por favor, entre somente com dígitos .",
		equalTo: "Entre com o mesmo valor novamente.",
		maxlength: $.validator.format( "A quantidade máxima de caracteres é {0} ." ),
		minlength: $.validator.format( "Insira no mínimo {0} carateres." ),
		rangelength: $.validator.format( "Insira um valor entre {0} e {1} ." ),
		...
		step: $.validator.format( "Entre com uma valor múltiplo de {0}." )
	},
